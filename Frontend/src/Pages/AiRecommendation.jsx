...
import { getAIRecommendation } from '../lib/AiModel.js'
import RecommendedMovies from '../Componenets/RecommendedMovies.jsx';
...
const AIRecommendations = () => {
  ...
  const generateRecommendations = async () => {
    ...
    // dynamic prompt for Gemini AI 
    const userPrompt = `
      Given the following user input: 
      Decade: ${input.decade}, Genre: ${input.genre}, Language: ${input.language}, Mood: ${input.mood}. 
      Recommend 10 movies. Return the list as a plain JSON array of movie titles only. 
      No extra text, no markdown. Example: ["Movie 1", "Movie 2"]
    `;
